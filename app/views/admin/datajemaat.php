                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3 row">
                                                <label for="no_nik" class="col-sm-3 col-form-label">Nomor Induk
                                                    KTP</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="no_nik" name="nik">
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
                                            ...
                                            <div class="mb-3 row">
                                                <label for="alamat_jemaat" class="col-sm-3 col-form-label">Alamat
                                                    Lengkap</label>
                                                <div class="col-sm-9">
                                                    <textarea class="form-control" id="alamat_jemaat"
                                                        name="alamat_jemaat" rows="3"></textarea>
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-select" id="status_menikah"
                                                        name="status_menikah">
                                                        <option></option>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="admin/editjemaat" class="badge bg-primary me-1">Edit</a><a
                                            href="<?= BASEURL; ?>admin/hapusjemaat/<?= $jemaat['id_jemaat']; ?>"
                                            class="badge bg-danger">Hapus</a></td>
                                </tr>
                                <?php endforeach ?>
                            </tbody>
                        </table>
