    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-layout-text-window-reverse"></i><span>Data Gereja</span><i
                    class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="<?= BASEURL; ?>admin/pendeta">
                        <i class="bi bi-circle"></i><span>Data Pendeta</span>
                    </a>
                </li>
                <li>
                    <a href="<?= BASEURL; ?>admin/pengurus">
                        <i class="bi bi-circle"></i><span>Data Pengurus</span>
                    </a>
                </li>
                <li>
                    <a href="<?= BASEURL; ?>admin/jemaat">
                        <i class="bi bi-circle"></i><span>Data Jemaat</span>
                    </a>
                </li>
            </ul>
        </li><!-- End Tables Nav -->
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-menu-button-wide"></i><span>Dokumen Online</span><i
                    class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="<?= BASEURL; ?>admin/warta">
                        <i class="bi bi-circle"></i><span>Warta Jemaat</span>
                    </a>
                </li>
                <li>
                    <a href="components-accordion.html">
                        <i class="bi bi-circle"></i><span>E-Books</span>
                    </a>
                </li>
                <li>
                    <a href="components-badges.html">
                        <i class="bi bi-circle"></i><span>Dokumen Kehadiran</span>
                    </a>
                </li>
            </ul>
